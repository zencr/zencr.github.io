        ...
        const geojsonObject = {
            ...
            'features': [
                ...
                },
                {
                    ...
                    'geometry': {
                        'type': 'Polygon',
                        'coordinates': [ // Terra Island
                            [
                                ol.proj.transform([-100, 1200], dataProjection, viewProjection),
                                ol.proj.transform([-400, 1200], dataProjection, viewProjection),
                                ol.proj.transform([-400, 900], dataProjection, viewProjection),
                                ol.proj.transform([-100, 900], dataProjection, viewProjection),
                            ],
                        ],
                    },
                },
                ...
                },
                {
                    ...
                    'geometry': {
                        ...
                        'coordinates': [ // Jerkies
                            [
                                ol.proj.transform([-1500, -785], dataProjection, viewProjection),
                                ol.proj.transform([-1915, -785], dataProjection, viewProjection),
                                ol.proj.transform([-1915, -1000], dataProjection, viewProjection),
                ...
                },
                {
                    ...
                    'geometry': {
                        ...
                        'coordinates': [ // Jerkies
                            [
                                ol.proj.transform([-1100, -1000], dataProjection, viewProjection),
                                ol.proj.transform([-1100, -1321], dataProjection, viewProjection),
                                ol.proj.transform([-985, -1321], dataProjection, viewProjection),
                                ol.proj.transform([-985, -1000], dataProjection, viewProjection),
                            ],
                        ],
                    },
                },
                {
                    ...
                    'geometry': {
                        ...
                        'coordinates': [ // Jerkies
                            [
                                ol.proj.transform([-985, -1125], dataProjection, viewProjection),
                                ol.proj.transform([-490, -1125], dataProjection, viewProjection),
                                ol.proj.transform([-490, -1153], dataProjection, viewProjection),
                                ol.proj.transform([-985, -1153], dataProjection, viewProjection),
                            ],
                        ],
                    },
                },
                {
                    ...
                    'geometry': {
                        ...
                        'coordinates': [ // YeetGenic
                            [
                                ol.proj.transform([1500, -1000], dataProjection, viewProjection),
                                ol.proj.transform([2000, -1000], dataProjection, viewProjection),
                                ol.proj.transform([2000, -1500], dataProjection, viewProjection),
                                ol.proj.transform([1500, -1500], dataProjection, viewProjection),
                            ],
                        ],
                    },
                },
