            ...
            'features': [
                {
                    ...
                    'geometry': {
                        ...
                        'coordinates': [ // Hexacorp
                            [
                                ol.proj.transform([-500, -200], dataProjection, viewProjection),
                                ol.proj.transform([-300, -200], dataProjection, viewProjection),
                                ol.proj.transform([-300, -400], dataProjection, viewProjection),
                                ol.proj.transform([-500, -400], dataProjection, viewProjection),
                            ],
                        ],
                    },
                },
